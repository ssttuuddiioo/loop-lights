// Pulse - smooth breathing fade between two colors for ENTTEC ELM
//
// ELM Parameters:
//   Force    (1-10) = Color 1 hue
//   Force 2  (1-10) = Color 2 hue
//   Nb Items (0-10) = Breathing rate
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
    ...
    float rate = max(iNbItems + 0.0, 1.0) * 0.3;
    // Spatial phase offset so different areas breathe at different times
